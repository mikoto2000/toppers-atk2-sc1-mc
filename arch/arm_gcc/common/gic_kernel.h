 ...
 *  の責任を負わない．
 * 
 *  $Id: gic_kernel.h 780 2017-03-07 01:32:17Z ertl-honda $
 */
 ...
 */
Inline void
gicd_disable_int(InterruptNumberType intno)
{
 ...
 */
Inline void
gicd_enable_int(InterruptNumberType intno)
{
 ...
 */
Inline void
gicd_clear_pending(InterruptNumberType intno)
{
 ...
 */
Inline void
gicd_set_pending(InterruptNumberType intno)
{
 ...
 */
Inline bool_t
gicd_probe_pending(InterruptNumberType intno)
{
 ...
 */
Inline void
gicd_config(InterruptNumberType intno, uint_t config)
{
 ...
 */
Inline void
gicd_config_group(InterruptNumberType intno, uint_t group)
{
 ...
 */
Inline void
gicd_set_priority(InterruptNumberType intno, uint_t pri)
{
 ...
 */
Inline void
gicd_set_target(InterruptNumberType intno, uint_t prcs)
{
	uint_t		shift = (intno % 4) * 8;
	uint32_t	reg;
	SIL_PRE_LOC;
 ...
 */
extern const FP* const p_inh_table[];
